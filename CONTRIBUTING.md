# Contributing to ultimed-i18n

Open source projects like `ultimed-i18n` live on your words of encouragement and contribution. Please give feedback, report issues, or submit pull requests!
...
1. Fork and clone this repo.
    ...
    ```sh
    git clone git@github.com:<your-github-handle>/ultimed-i18n.git
    ```
...
1. [Create a tag](https://github.com/<your-github-handle>/ultimed-i18n/releases/new) and provide release notes. The tag name should match the workspace root's version (e.g. `0.1.2`).
